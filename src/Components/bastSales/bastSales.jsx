  ...
  async function addToCart(id) {
    ...
    toast.success(
      <div className="text-center">
        The product has been added to the donation  &#129303;
      </div>,
      {
        duration: 1000,
        icon: (
            ...
            <div className='trand-item'>
              ...
              <div className='trand-product-info'>
                ...
                <div className='trand-product-price'>
                  <p>TRY {product.price}</p>
                  <button className='btn bg-color text-white fw-bold' onClick={() => addToCart(product.id)}>Add to donation  </button>
