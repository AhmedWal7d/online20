              ...
              <div className='product-data'>
                {data?.slice(39, 40).map((product) => <div key={product.id}>
                  ...
                  <div className='price'>
                    ...
                    <p className='old-price' data-aos="fade-right" data-aos-duration="1000">   TRY   {product.price * 2}  </p>
                    <p className='new-price' data-aos="fade-right" data-aos-duration="1000"> TRY  {product.price}</p>
                  </div>
                </div>)}
