...
async function registerSubmit(values) {
  ...
  try {
    // Send the payload in the body of the POST request
    const { data } = await axios.post('https://ecommerce.routemisr.com/api/v1/auth/signup', payload);
  ...
  let validationSchema = Yup.object({
    ...
    phone: Yup.string().matches(phoneRegExp, " Enter TRYptian Number").required("phone is required"),
